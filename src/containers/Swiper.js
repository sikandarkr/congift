    ...
    render() {
        ...
        return (
            <View style={[styles.container, containerStyle]} onLayout={this._onLayout.bind(this)}>
                <View style={[styles.sliderContainer, swipeAreaStyle,{flexDirection:'column'}]}>
                    <Animated.View
                        style={[{
                            position: "relative",
                            top: 0,
                    ...
                    {!buttonsEnabled ? null : (
                        <View style={[styles.controlsWrapperStyle, {
                            flexDirection: direction, justifyContent: 'center'
                        }, direction === "row" ? { left: 0 } : { bottom: normalize(0) }, controlsWrapperStyle]}>
                            ...
                            {this.props.close ? <View style={{ position: 'absolute', right: normalize(20) }}>
                                <TouchableOpacity onPress={() => this.props.onClose()}>
                                    <Text style={[COMMON_STYLES.SMALL_TEXT_SIZE,COMMON_STYLES.PRIMARY_COLOR]}>{'Skip'}</Text>
                                </TouchableOpacity>
                            </View> : null}
                        </View>
                    )}
